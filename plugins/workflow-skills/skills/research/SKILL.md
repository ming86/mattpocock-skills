...
3. **Collect only useful evidence.** Follow a claim back far enough to verify it reliably, then stop. Do not turn focused research into an exhaustive literature review unless the task requires one.
